 ...
 *
 * Note: the "Dot" and "Dot in the corner" previews are NOT made live here. `Badge` (see
 ...
 * so a live demo for those two previews is not possible without changing the component itself,
