export const annotationMessages = {
  es: {
    ...
    "annotation.runtimeBody1":
      "Dónde va una etiqueta no es un valor que se pueda escribir al componer: sale de dónde <em>cayó</em> su parte, que sale del layout del sujeto, que cambia cuando se redimensiona el contenedor, cuando el sujeto reflowea o cuando llega una tipografía. Es la misma línea que separa a todo contrato con máquina de los patrones puramente CSS de al lado: un hecho de runtime, no uno autorado.",
    ...
    "annotation.test11": "Lee el margen de las cajas medidas, no del pedido autorado.",
    ...
    "annotation.test38": "Se monta una sola vez por raíz autorada.",
    ...
    "annotation.test64": "Todos los anillos tienen el mismo radio, sea cual sea la forma de la parte.",
    ...
    "annotation.test73": "El marco elige el radio del anillo, y una etiqueta suelta puede pisarlo.",
  ...
  en: {
    ...
    "annotation.test64": "Every ring gets the same radius, whatever shape the part is.",
    ...
    "annotation.test73": "The frame chooses the ring radius, and a single label can override it.",
