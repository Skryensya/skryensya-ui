export const heroMessages = {
  es: {
    ...
    "demo.hero.splitTitle": "Ve todo tu producto en una sola vista.",
    ...
    "demo.hero.emailBody": "Déjanos tu correo y te avisamos apenas abramos el acceso anticipado.",
    "demo.hero.emailFieldLabel": "Correo electrónico",
    "demo.hero.emailPlaceholder": "tu@empresa.com",
    "demo.hero.emailAction": "Unirme a la lista",
    "demo.hero.appTitle": "Llévalo a todos lados.",
    ...
    "demo.hero.pricingBody": "Cambia entre mensual y anual, cancela cuando quieras.",
    ...
    "demo.hero.codeTitle": "Intégralo en minutos, no en sprints.",
    ...
    "demo.hero.tabsAriaLabel": "Elige tu perfil",
