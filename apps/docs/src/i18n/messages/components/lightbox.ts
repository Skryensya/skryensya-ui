export const lightboxMessages = {
  es: {
    ...
    "lightbox.tryBody":
      "Prueba <kbd>←</kbd> y <kbd>→</kbd>, <kbd>+</kbd>, <kbd>-</kbd> y <kbd>0</kbd>, la rueda, doble clic sobre la foto y arrastrar con zoom. En táctil: deslizar cambia de foto, pellizcar acerca, doble toque acerca y deslizar hacia abajo cierra.",
    "lightbox.singleTitle": "Una sola imagen",
    "lightbox.singleBody":
      "Con una imagen no hay contador ni flechas: nada que una sola foto no necesite. Esta es una panorámica 3:1; la imagen siempre conserva su proporción y nunca se agranda más allá de sus propios píxeles.",
    ...
    "lightbox.a11yItem4":
      "Cada gesto tiene un botón y una tecla: deslizar es Anterior/Siguiente, pellizcar es Acercar/Alejar, deslizar hacia abajo es Cerrar. Los controles miden 44 px y están sobre una superficie propia, legible sobre fotos claras u oscuras.",
    "lightbox.a11yItem5":
    ...
    "lightbox.demo.credit": "Ilustración generada para esta documentación",
    "lightbox.demo.dawnAlt": "Un lago al amanecer, con el sol sobre una línea de cerros y su reflejo en el agua",
    "lightbox.demo.dawnTitle": "Amanecer en el lago",
    "lightbox.demo.dawnDescription": "La primera luz, antes de que se levante el viento.",
    "lightbox.demo.forestAlt": "Un bosque de pinos que se oscurece hacia el suelo",
    "lightbox.demo.forestTitle": "Bosque",
    "lightbox.demo.panoramaAlt": "Una panorámica ancha de cerros azules sobre una llanura dorada",
    "lightbox.demo.panoramaTitle": "Panorámica",
    "lightbox.demo.panoramaDescription": "Una imagen tres veces más ancha que alta: siempre conserva su proporción.",
    "lightbox.demo.lighthouseAlt": "Un faro a rayas rojas y blancas bajo un cielo estrellado",
    "lightbox.demo.lighthouseTitle": "Faro",
    "lightbox.demo.snowAlt": "Un campo nevado casi blanco con una fila de pinos pequeños",
    "lightbox.demo.snowDescription": "Casi toda blanca: los controles mantienen su contraste sobre su propia superficie.",
    "lightbox.demo.tinyAlt": "Un sol pálido sobre un cielo naranja",
  ...
  en: {
    ...
    "lightbox.tryBody":
      "Try <kbd>←</kbd> and <kbd>→</kbd>, <kbd>+</kbd>, <kbd>-</kbd> and <kbd>0</kbd>, the wheel, a double click on the photo and dragging while zoomed. On touch: a swipe changes photo, a pinch zooms, a double tap zooms and a swipe down closes.",
    "lightbox.singleTitle": "A single image",
    "lightbox.singleBody":
      "With one image there is no counter and there are no arrows: nothing a single photo does not need. This is a 3:1 panorama; the image always keeps its ratio and is never enlarged past its own pixels.",
    ...
    "lightbox.a11yItem4":
      "Every gesture has a button and a key: a swipe is Previous/Next, a pinch is Zoom in/out, a swipe down is Close. The controls are 44px and sit on a surface of their own, readable over light or dark photos.",
    "lightbox.a11yItem5":
    ...
    "lightbox.demo.credit": "Illustration generated for this documentation",
    "lightbox.demo.dawnAlt": "A lake at dawn, the sun above a line of hills and reflected in the water",
    "lightbox.demo.dawnTitle": "Dawn on the lake",
    "lightbox.demo.dawnDescription": "First light, before the wind picks up.",
    "lightbox.demo.forestAlt": "A pine forest darkening toward the ground",
    "lightbox.demo.forestTitle": "Forest",
    "lightbox.demo.panoramaAlt": "A wide panorama of blue hills above a golden plain",
    "lightbox.demo.panoramaTitle": "Panorama",
    "lightbox.demo.panoramaDescription": "An image three times wider than it is tall: it always keeps its ratio.",
    "lightbox.demo.lighthouseAlt": "A red-and-white striped lighthouse under a starry sky",
    "lightbox.demo.lighthouseTitle": "Lighthouse",
    "lightbox.demo.snowAlt": "An almost white snowfield with a row of small pines",
    "lightbox.demo.snowDescription": "Almost all white: the controls keep their contrast on a surface of their own.",
    "lightbox.demo.tinyAlt": "A pale sun over an orange sky",
