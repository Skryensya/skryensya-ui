export const ratingMessages = {
  es: {
    ...
    "ratingPage.fractionBody":
      "Un promedio de 4,3 dibujado como 4 es el componente mintiendo sobre su propio dato, y peor: 4,3 y 3,8 quedarían idénticos. La tira se rellena en la fracción exacta, así que 4,3 de 5 corta al 86%.",
    ...
    "ratingPage.sizeBody":
      "<code>symbolSize</code> mueve el símbolo, no el área de interacción: cada radio conserva su piso de blanco táctil, que importa más acá que en casi cualquier otro control porque hay cinco uno al lado del otro.",
  ...
  en: {
    ...
    "ratingPage.fractionBody":
      "An average of 4.3 drawn as 4 is the component lying about its own data, and worse: 4.3 and 3.8 would look identical. The strip fills the exact fraction, so 4.3 out of 5 stops 86% across.",
    ...
    "ratingPage.sizeBody":
      "<code>symbolSize</code> moves the symbol, not the interaction area: each radio keeps its touch-target floor, which matters more here than in almost any other control because five of them sit side by side.",
