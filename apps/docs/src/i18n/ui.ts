...
export const ui = {
  es: {
    ...
    "hookPlayground.reset": "Restablecer",
    ...
    "demo.pricingCard.price": "$29",
    "demo.pricingCard.period": "/mes",
    "demo.pricingCard.feature1": "Proyectos ilimitados",
    "demo.pricingCard.feature2": "Soporte prioritario",
    "demo.pricingCard.feature3": "Exportación a PDF",
  ...
  en: {
    ...
    "demo.settingsRow.title": "Dark mode",
    "demo.settingsRow.description": "Switches the whole app to a dark palette.",
    "demo.alertRetry.title": "We couldn't save your changes",
    "demo.alertRetry.body": "The last save attempt failed. Check your connection and try again.",
    "demo.alertRetry.action": "Try again",
    "demo.profile.status": "Online",
    "demo.pricingCard.plan": "Pro",
    "demo.pricingCard.price": "$29",
    "demo.pricingCard.period": "/mo",
    "demo.pricingCard.feature1": "Unlimited projects",
    "demo.pricingCard.feature2": "Priority support",
    "demo.pricingCard.feature3": "PDF export",
