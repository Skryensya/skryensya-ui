...
export const ui = {
  es: {
    ...
    "demo.accordion.runtime.p2": "El healthcheck pega a /status cada diez segundos; tres fallos seguidos sacan la réplica del balanceador sin cortar el tráfico en vuelo.",
  ...
  en: {
    ...
    "demo.accordion.runtime.p2": "The healthcheck hits /status every ten seconds; three failures in a row take the replica out of the balancer without cutting off in-flight traffic.",
    "demo.accordion.rollout.title": "Rollout",
