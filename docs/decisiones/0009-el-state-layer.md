...
El state layer es [un pattern](/decisiones/0008-que-envia-tier-3) según la regla de qué envía tier 3, 
...
[motion](/decisiones/0010-motion-por-tokens-de-intencion).
...
- El foco lleva un anillo independiente, verificado a ≥3:1 por
  [el validador](/decisiones/0007-el-validador). Por eso vive en su propia familia `--focus-ring-*` y
