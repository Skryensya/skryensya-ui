...
que habría que enviar, exactamente lo que [no se hace](/decisiones/0006-css-puro-sin-build). Exigir
...
Según [la regla de qué envía tier 3](/decisiones/0008-que-envia-tier-3): `components/dialog.css`
...
porque los dos consumen los mismos [tokens de intención](/decisiones/0010-motion-por-tokens-de-intencion)
`--motion-enter-*`.
...
[el validador](/decisiones/0007-el-validador) lo exime de las verificaciones de contraste por decorativo
...
[`oklch()`](/decisiones/0005-los-primitivos-de-color-se-escriben-en-oklch). La página de `::backdrop` en
