#!/usr/bin/env node
/*
 * The AI UI platform is under greenfield reconstruction (docs/ai-ui-platform.md). Until its gates
...
console.error(
  [
    ...
    "  Plan:           docs/ai-ui-platform.md",
    "  Decisiones:     docs/decisions/0028..0031",
    "",
