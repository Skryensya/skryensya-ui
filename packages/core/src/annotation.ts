...
export const annotationContract = {
  ...
  hooks: [
    ...
    "--sk-annotation-bubble-bg",
    "--sk-annotation-bubble-bg-active",
    "--sk-annotation-bubble-border-color",
    "--sk-annotation-bubble-border-color-active",
    "--sk-annotation-bubble-padding-block",
    "--sk-annotation-bubble-padding-inline",
    "--sk-annotation-bubble-radius",
    "--sk-annotation-bubble-shadow",
    "--sk-annotation-bubble-wash",
    "--sk-annotation-color",
    "--sk-annotation-color-active",
    "--sk-annotation-font-family",
    "--sk-annotation-font-size",
    "--sk-annotation-font-weight",
    "--sk-annotation-leader-width",
    "--sk-annotation-line-height",
    "--sk-annotation-ring-color",
    "--sk-annotation-ring-color-rest",
    "--sk-annotation-ring-width",
  ],
