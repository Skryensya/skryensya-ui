/*
 * Lucide enlazado al vocabulario estable, un set de iconos es una marca (decisión 15).
 *
 ...
 * (decisión 2), y sus dependencies están vacías. Aquí Lucide es una devDependency, la geometría se
