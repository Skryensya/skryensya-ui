/*
 * Phosphor Icons bound to the stable vocabulary; an icon set is a brand (decision 15).
 *
 ...
 * (decision 2), and its dependencies are empty. Here Phosphor Icons is a devDependency, the geometry was
